...
`;
 ...
 smd({
   ...
   category: "downloader",
   filename: __filename,
   use: "<Hii,this is MSELA-CHUI-V2>"
 }, async (_0x55aba2, _0x56da6b) => {
   try {
     let _0x204f81 = _0x55aba2.reply_text ? _0x55aba2.reply_text : _0x56da6b;
     if (!_0x204f81) {
       return _0x55aba2.reply("*_Example : .tts Hi,I am MSELA-CHUI-V2 whatsapp bot._*");
     }
     try {
       ...
       await _0x55aba2.bot.sendMessage(_0x55aba2.jid, {
         ...
         mimetype: "audio/mpeg",
         ptt: true,
         fileName: "MSELA-CHUI-V2-tts.m4a"
       }, {
         quoted: _0x55aba2
       });
     }
 ...
 smd({
   ...
   try {
     ...
     let _0x4737bb = {
       audio: _0x2ba501,
       fileName: "MSELA-CHUI-V2 tiktok Sound" + _0x19c223 + ".m4a",
       mimetype: "audio/mpeg",
       ptt: true,
 ...
 smd(
   ...
   async (m, url) => {
     try {
       ...
       const caption = `『 *MSELA-CHUI-V2 • MEDIAFIRE DOWNLOADER* 』\n\n *Name* : ${result.name}\n *Size* : ${result.size}\n *Mime* : ${result.mime}\n\n\n${Config.caption}`;
 ...
 cmd({
   ...
   if (_0xb75e78.quoted && _0xb75e78.text) {
     ...
     if (_0x5b8ee5[0].includes("MSELA-CHUI-V2 • SONG DOWNLOADER")) {
     ...
     } else if (_0x5b8ee5[0].includes("MSELA-CHUI-V2 • YOUTUBE DOWNLOADER")) {
     ...
     } else if (_0x5b8ee5[0].includes("MSELA-CHUI-V2 • APK DOWNLOAD LIST")) {
